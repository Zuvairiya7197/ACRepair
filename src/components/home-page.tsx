      ...
      <main id="home">
        <section className="relative flex min-h-[100svh] items-center justify-center overflow-hidden px-4 py-24 text-[#0f4c45] sm:px-6 sm:py-28 lg:px-8">
          ...
          >
            <motion.h1
              variants={fadeUp}
              className="text-[clamp(1.95rem,8.4vw,2.25rem)] font-black leading-[0.96] tracking-normal text-[#0f4c45] sm:text-balance sm:text-[clamp(2.25rem,4.8vw,4.4rem)] sm:leading-[1.05]"
            >
              <span className="block whitespace-nowrap sm:inline sm:whitespace-normal">
                Get Your AC Cooling
              </span>
              <span className="mt-1 block whitespace-nowrap sm:mt-0 sm:inline sm:whitespace-normal">
                Again Today.
              </span>
            </motion.h1>
            <motion.p
